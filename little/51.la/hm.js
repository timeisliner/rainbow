(function() {
    ...
    mt.localStorage.set = function(a, b, d) {
        ...
        try {
            ...
            window.localStorage.setItem(a, b)) : mt.localStorage.D() && (mt.localStorage.g.expires = f.toUTCString(),
    ...
    (function() {
        ...
        var g = mt.event, n = h.H, l = r, p = r, e = r, k = r, w = +new Date, m = w, s = 0, y = r, v = d("visibilityState"), x = d("hidden"), z;
        b();
        (function() {
        ...
        var d = mt.lang
          ...
          , e = {
            ...
            _trackEvent: function(a) {
                ...
                h.b.a.st = 4,
                h.b.a.et = 4,
                h.b.a.ep = d.k(a[1]) + "*" + d.k(a[2]) + (a[3] ? "*" + d.k(a[3]) : "") + (a[4] ? "*" + d.k(a[4]) : ""),
                h.b.j())
            },
            ...
            _trackRTEvent: function(a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m)
                        ...
                        for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.Q).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++)
                            l.push(v),
    ...
    (function() {
        ...
        a.prototype = {
            ...
            ta: function() {
                ...
                var a = u;
                this.A(document.referrer) && this.A(document.location.href) ? a = r : (a = b.W(document.referrer),
            ...
            Ma: function() {
                ...
                if (0 === c.nv && this.A(document.location.href) && ("" === document.referrer || this.A(document.referrer)))
                    a = 0,
                    b = 4;
                this.a.nv = a;
                this.a.st = b;
            ...
            ga: function() {
                ...
                a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.Q),
